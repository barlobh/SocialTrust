...
import { Shield, TrendingUp, Zap, Users, Star, CheckCircle, Award, Target, BarChart3, Rocket, Crown, Sparkles, ArrowRight, Globe, Lock, Eye } from 'lucide-react';

export default function InstantProofHybrid() {
    const [trustScore, setTrustScore] = useState(null);
    const [analyzing, setAnalyzing] = useState(false);
    const [businessUrl, setBusinessUrl] = useState('');

    const generateTrustScore = () => {
        setAnalyzing(true);
        setTimeout(() => {
            setTrustScore({
                score: 94,
                    ...
                    <div className="bg-gradient-to-br from-white/10 via-white/5 to-transparent rounded-3xl p-8 border border-white/10 backdrop-blur-xl mb-8 shadow-2xl">
                        ...
                        {analyzing && (
                            <div className="mt-8 space-y-3">
                                {[
                                    'Scanning Google Reviews & Maps...',
                                    'Analyzing Reddit, Twitter, Facebook...',
                                    'Reading forum discussions...',
                                    'Processing customer sentiment...',
